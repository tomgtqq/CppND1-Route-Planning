...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
    // Populate the current node neighbors vector with all the neighbors
...
RouteModel::Node* RoutePlanner::NextNode() {
    ...
    std::sort(open_list.begin(), open_list.end(), [](const auto n1, const auto n2){
        auto n1_f_value = n1->h_value + n1->g_value;
        auto n2_f_value = n2->h_value + n2->g_value;
        return n1_f_value > n2_f_value;
    });
...
void RoutePlanner::AStarSearch() {
    ...
    // TODO: Implement your solution here.
    // set start_node visited as true and add to open list 
